  ...
  <?php
   ...
   <table border='1'>
    <?php
      ...
      echo "<tr><td>ID</td><td>Nombre</td><td>Apellido</td><td>Documento</td><td>Edad</td><td>Borrar</td><td>Modificar</td></tr>";
      while ($filaPDO=$ejecucionSQL->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td align='center'><a href='edituser.php?ide={$filaPDO[id]}'>X</a></td>";
        echo "</tr>";
      }
     ?>
   </table>
